...
def liveER():
    ...
    unresolved_coll=db['entities_unresolved_weekly']
    resolved_col='entities_resolved_overall'

    cursor1 = unresolved_coll.find({"resolved":False}, no_cursor_timeout=True)#.limit(10)
    cursor2 = db[resolved_col].find({},no_cursor_timeout=True)#.limit(10)
