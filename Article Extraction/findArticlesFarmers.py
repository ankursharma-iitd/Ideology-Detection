...
x = art_db.articles.find({'text': {'$regex': 'farm loan|crop loan|farmer suicide|debt waiver|waiver scheme|farming community|farmer agitation|plight farmer|distressed farmer|farmer issue|farmers protest|farmer\'s protest|agrarian crisis|agrarian unrest|farmers protests|farmer\'s protests|loan waivers|loan waiver|agriculture protest|farmers march|farmer\'s march', '$options': 'i'}},
