...
coll_name = 'farmers_articles_final'
...
aliases = ['farmers protest','farmer\'s protest','agrarian crisis','agrarian unrest','farmers protests','farmer\'s protests','loan waivers','loan waiver','agriculture protest','farmers march','farmer\'s march','farm loan','crop loan','farmer suicide','debt waiver','waiver scheme','farming community','farmer agitation','plight farmer','distressed farmer','farmer issue']
