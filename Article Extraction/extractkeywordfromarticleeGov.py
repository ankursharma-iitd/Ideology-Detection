...
coll_name = 'e-governance_articles_Final'
...
# aliases = ['Digit India','Digital Swades','India Digital','Digital India','Digital Desh']
aliases = ['e-governance','information and communication technology','e-govt','e-government','electronic governance','paperless office','communication technology','ict academy','ict sector','ict information','ict tool','e-district','m-governance']

# 'Enter the fixword that u want aliases to be replaced with '
fix_keyword = 'governance'
